...
(function(){
    ...
    for(var i=0; i<vimeo.length; i++){
        ...
        var data_id    = vimeo[i].dataset.id,
            ...
            data_size  = vimeo[i].dataset.size,
            vi_image   = new Image(),
        ...
        /**
         * @source https://vimeo.com/api/oembed.json?url=https://vimeo.com/426718199
         * @output https://i.vimeocdn.com/video/905229767_900x600.webp
         */

		$.getJSON('https://vimeo.com/api/oembed.json?url=https://vimeo.com/'+ data_id, function(data) {
			var url = data['thumbnail_url'];
			var regex = /^.*(?=(\_))/g;
			var final = url.match(regex);
			vi_image.src = final[0];
			vi_image.alt = 'video-thumbnail';
		});

        // vi_image.src = 'https://i.vimeocdn.com/video/' + data_thumb + '_' + data_size + '.webp';
        // vi_image.alt = 'video-thumbnail';
